...
// ==============================================
// ExpenseFilters Component — Phase 2
// Rich, modern filters panel (search, category combobox,
// account, date range presets, amount, checkboxes)
// ==============================================
...
export function ExpenseFilters({
  ...
  const hasActiveFilters =
    ...
    filters.isReimbursable !== undefined;
  ...
  return (
    <div className="space-y-3 rounded-xl border border-border/60 bg-card/40 p-4 backdrop-blur-md">
      ...
      {showAdvanced && (
        <div className="grid gap-4 border-t border-border/50 pt-4 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="flex flex-col justify-end gap-3 pb-1">
            ...
            <div className="flex items-center gap-2">
              <Checkbox
                id="filter-reimbursable"
                checked={filters.isReimbursable ?? false}
                onCheckedChange={(checked) =>
                  onFiltersChange({
                    ...filters,
                    isReimbursable: checked === true ? true : undefined,
                    page: 1,
                  })
                }
              />
              <Label htmlFor="filter-reimbursable" className="text-xs font-normal cursor-pointer">
                Reimbursable only
              </Label>
            </div>
          </div>
